...
void main() 
{
	...
	{
		printf("Passed test of great hall card added to hand.\n");
	}
	else
	{
		printf("Failed test of great hall card added to hand.\n");
	}
	
	//Checks if the action +1 was added to player
	if((testState.numActions+1) == copy->numActions)
	{
		printf("Passed test of great hall action added.\n");
	}
	else
	{
		printf("Failed test of great hall action added.\n");
	}
